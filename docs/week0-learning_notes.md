...
**Note:** Weekly learning notes are organized in separate files in the `docs/` folder. This file contains pre-course planning and course structure decisions.
...
| PostgreSQL | Week 4 | Relational data for family accounts |
| Redis | Week 4 | Caching blockchain data, pub/sub |
| Hardhat | Week 1 | Smart contract development |
| Go | Week 11 | High-performance event listeners, DEX price oracles |
| PSD2 APIs | Week 15 | Portuguese banking integration |
| Python | Week 17 | Data analytics and banking features |
| Uniswap/DEX protocols | Optional Module A | AMM mechanics, liquidity pools |
| Polygon/Arbitrum | Week 23 | Multi-chain deployment, L2 solutions |
| Bridge contracts | Optional Module B | Cross-chain token transfers |
| Docker | Week 29 | Containerization for deployment |
| React | Week 6 | Frontend dashboard |
...
- [x] ~~How to make the learning curve gentler for Module 2 (PSD2) if banking APIs are complex?~~ **RESOLVED:** Moved PSD2 to Week 15 after building core blockchain platform
